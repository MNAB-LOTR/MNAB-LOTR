  ...
  const games = [
    {
      ...
      description: 'Een episch fantasyverhaal over de strijd tussen goed en kwaad in Midden-aarde.',
    },
    {
      name: 'Fortnite',
      image: '/assets/images/Fortnite.jpeg',
      description: 'Een "battle royale" game met constante updates en een creatieve bouwmodus.',
    },
    {
      name: 'FIFA',
      image: '/assets/images/FIFA.jpeg',
      description: 'Een populaire voetbalgame met realistische gameplay en jaarlijkse updates.',
    },
    {
      name: 'Pokémon',
      image: '/assets/images/Pokémon.jpg',
      description: 'Een wereldberoemde franchise met games, anime en kaartspellen waarin spelers Pokémon vangen.',
    },
    {
      name: 'LEGO Masters',
      image: '/assets/images/legoMasters.jpg',
      description: 'Een realityshow waarin deelnemers strijden om de beste LEGO-kunstwerken te maken.',
    },
    {
      name: 'Magic: The Gathering',
      image: '/assets/images/MTG.jpg',
      description: 'Een strategisch kaartspel met uitgebreide lore en miljoenen spelers wereldwijd.',
    },
  ];
...
app.post('/register', async (req: Request, res: Response) => {
  ...
  try {
    ...
    return res.status(500).send(error.message || 'Er ging iets mis bij registratie.');
  }
});
